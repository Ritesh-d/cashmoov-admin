...
export class FeeCommissionTemplateComponent implements OnInit {
...
callOnLoad(){
  ...
  viewFee(template :any){
     ...
     this.router.navigate(['../viewFeeTemplate'], { relativeTo: this.route, skipLocationChange: true, queryParams: { data: JSON.stringify(template), temp:JSON.stringify(tmp),display:this.display}});
