...
export class AddWalletOwnerService {
  ...
  constructor(private http: HttpClient, 
    private mastersViewModelBuilder: MastersViewModelBuilder,private commonHttpService: CommonHelperService,
  ...
  prepareAddressRequest(addressData: any): WalletOwnerAddressRequest {
    ...
    console.log('--addAddressRequest--', addAddressRequest);
  ...
  public walletOwnerDone(walletOwnerCode: string, basicInfoData: any,categoryCode:string): Observable<any> {
     if(basicInfoData.mobileNumber===0){
      basicInfoData.mobileNumber = "";
     }
