...
export class BasicInfoService {
  ...
  public updateWalletOwner(formData: any,wllletOwnerCode:string): Observable<any> {
    return this.http.put<any>(this.getWalletUrl(this.addWalletOwnerService.selectedCategoryCode) +'/'+wllletOwnerCode, this.prepareCreateWalletOwnerRequest(formData));
  }
  ...
  */
  ...
  public prepareCreateWalletOwnerRequest(formData: any): WalletOwnerBasicInfoRequestModel {
    ...
    console.log('--createWalletOwnerRequest--', JSON.stringify(createWalletOwnerRequest));
  ...
  public createWalletOwner(formData: any): Observable<any> {
    return this.http.post<any>(this.getWalletUrl(this.addWalletOwnerService.selectedCategoryCode), this.prepareCreateWalletOwnerRequest(formData));
  }
