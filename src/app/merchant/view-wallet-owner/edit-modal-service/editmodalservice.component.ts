...
export class EditServiceComponent  implements OnInit{
  ...
  status: string;
  code: string;
  constructor( private walletOwnerService: MerchantService, private approvalService : ApprovalService, private formBuilder: FormBuilder, private router: Router, private activatedrouter: ActivatedRoute,
