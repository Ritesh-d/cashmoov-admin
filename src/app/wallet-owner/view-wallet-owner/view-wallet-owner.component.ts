...
import { viewTemplateModalComponent } from './viewtemplate/viewtemplate.component';
        ...
        this.walletOwnerService.getWalletOwnerByCode(this.walletOwnerCode).subscribe(data => {
          if (data.resultCode === '0') {
            this.walletOwner = data.walletOwner;
             ...
             console.log(' this.walletOwner', this.walletOwner);
  ...
  onTemplateClicked() {
    ...
    this.walletOwnerService.getTemplateCategoryMasters().subscribe(res => {
      if (res["resultCode"] === '0') {
        ...
        if(this.templateCategoryList){
          this.templateCategoryList = this.templateCategoryList.filter(m=>{
