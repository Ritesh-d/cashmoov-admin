...
@Component({
  selector: 'app-agent-view-wallet-owner',
  templateUrl: './agent-view-wallet-owner.component.html',
  styleUrls: ['./agent-view-wallet-owner.component.css']
})
export class ViewAgentWalletOwnerComponent implements OnInit {
