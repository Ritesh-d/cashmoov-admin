...
export class EditServiceComponent  implements OnInit{
  ...
  status: string;
  code: string;
  constructor( private walletOwnerService: EmployerService, private approvalService : ApprovalService, private formBuilder: FormBuilder, private router: Router, private activatedrouter: ActivatedRoute,
