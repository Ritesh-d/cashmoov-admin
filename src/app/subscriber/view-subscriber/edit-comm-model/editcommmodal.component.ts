...
export class EditCommissionModalComponent {
  ...
  constructor(public activeModal: NgbActiveModal,private translate : TranslatelanguageService,private subscriberService: SubscriberService, private viewWalletOwnerService: ViewSubscriberService,  private formBuilder: FormBuilder, private router: Router, private activatedrouter: ActivatedRoute,
