...
@Component({
  selector: 'branch-app-add-wallet-owner',
  templateUrl: './branch-add-wallet-owner.component.html',
  styleUrls: ['./branch-add-wallet-owner.component.css']
})
export class AddBranchWalletOwnerComponent implements OnInit {
