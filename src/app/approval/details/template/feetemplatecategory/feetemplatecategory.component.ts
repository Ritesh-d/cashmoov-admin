...
import { ViewFeeComponent } from './service-view/viewservicetemplate.component';
@Component({
  selector: 'app-feetemplatecategory',
  templateUrl: './feetemplatecategory.component.html',
  styleUrls: ['./feetemplatecategory.component.css']
})
export class FeeTemplateComponent implements OnInit {
  ...
  async getDetail() {
    ...
    if (this.approvalData.entity) {
      ...
      this.serviceList = this.approvalData.entity.feeTemplateList;
