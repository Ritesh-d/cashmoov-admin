...
@Component({
  selector: 'app-branch-basic-info',
  templateUrl: './branch-basic-info.component.html',
  styleUrls: ['./branch-basic-info.component.css']
})
export class BranchBasicInfoComponent implements OnInit {
  minDateDOB:any;
  maxDateDOB:any;
