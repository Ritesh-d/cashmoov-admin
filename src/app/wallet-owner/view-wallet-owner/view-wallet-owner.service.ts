...
export class ViewWalletOwnerService {
    ...
    constructor(private http: HttpClient,private basicInfoService: BasicInfoService,
    ...
    createBasicInfoForm(walletOwner: any, editMode: boolean): FormGroup {
        ...
        if (walletOwner.lastName) {
            ...
            group['lastName'] = new FormControl({ value: '', disabled: !editMode }, Validators.required);
        }
    ...
    public updateBasicInfo(walletOwnerCode: string, basicInfoData: any,userTypeCode : string): Observable<any> {
        ...
        if( userTypeCode ==  WalletOwnerConstants.category.SUPERVISOR){
            return this.http.put(this.endpoints.E_WALLET_OWNER_URL + '/supervisor/' + walletOwnerCode,
            basicInfoData);
         }else if ( userTypeCode ==  WalletOwnerConstants.category.CASHIER){
             return this.http.put(this.endpoints.E_WALLET_OWNER_URL + '/cashier/' + walletOwnerCode,
            basicInfoData);
        }
