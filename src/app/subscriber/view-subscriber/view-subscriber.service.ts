...
import { SubscriberBasicRequestModel } from '../add-subscriber/basic-info/subscriber-basic-request-model';
...
import { SubscriberAddressRequestModel } from '../add-subscriber/address/subscriber-address-request-model';
...
//})
@Injectable()
export class ViewSubscriberService {
  ...
  basicInfoForm: FormGroup;
    ...
    createBasicInfoForm(walletOwner: any, editMode: boolean): FormGroup {
        ...
        this.basicInfoForm = new FormGroup(group);
    ...
    public updateAddressData(walletOwnerCode: string, addressData: any, newAddress?: boolean): Observable<any> {
        if (newAddress) {
            ...
            this.addSubscriberService.walletOwnerId = walletOwnerCode;
            return this.addSubscriberService.submitAddress(addressData);
        } else {
