...
@Component({
	selector: 'app-agent-ageing',
	templateUrl: './agent-ageing.component.html',
	styleUrls: ['./agent-ageing.component.css']
})

export class AgentAgeingReportComponent implements OnInit {
	...
	createReportForm() {
		this.createForm = this.formBuilder.group({
			reportType: ["Simple"],
			viewFormat: ["HTML"],
			setupName: ["report_cashmoov_agentageing"],
			fromDate : [],
			toDate : [],
