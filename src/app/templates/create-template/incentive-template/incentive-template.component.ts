...
@Component({
  selector: 'app-incentive-template',
  templateUrl: './incentive-template.component.html',
  styleUrls: ['./incentive-template.component.css']
})
export class IncentiveTemplateComponent implements OnInit {
  ...
  constructor(private approvalService: ApprovalService, 
    ...
    private commonHelperService: CommonHelperService,
     private mastersViewModel: MastersViewModelBuilder,
      private templateService: IncentiveTemplateService,
  ...
  viewIncentive(template: any) {
    ...
    this.router.navigate(['../viewIncentiveTemplate'], { relativeTo: this.route, skipLocationChange: true, queryParams: { data: JSON.stringify(template), temp: JSON.stringify(tmp), display: this.display } });
