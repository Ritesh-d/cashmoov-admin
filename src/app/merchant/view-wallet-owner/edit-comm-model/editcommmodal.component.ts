...
export class EditCommissionModalComponent {
  ...
  constructor(public activeModal: NgbActiveModal,private translate : TranslatelanguageService,private walletOwnerService: MerchantService, private viewWalletOwnerService: ViewWalletOwnerService,  private formBuilder: FormBuilder, private router: Router, private activatedrouter: ActivatedRoute,
