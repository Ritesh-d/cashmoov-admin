...
export class ViewWalletOwnerService {
    ...
    createBasicInfoForm(walletOwner: any, editMode: boolean): FormGroup {
        ...
        // walletOwner.walletOwnerCategoryCode = '100009';
        let group = {};
        group['businessName'] = new FormControl({ value: walletOwner.businessName, disabled: !editMode }, Validators.required);
        group['businessTypeCode'] = new FormControl({ value: walletOwner.businessTypeCode, disabled: !editMode }, Validators.required);
        group['email'] = new FormControl({ value: walletOwner.email, disabled: !editMode }, Validators.required);
        group['groupCode'] = new FormControl({ value: walletOwner.groupCode, disabled: !editMode }, Validators.required);
        group['idExpiryDate'] = new FormControl({ value: walletOwner.idExpiryDate, disabled: !editMode }, Validators.required);
        group['idProofNumber'] = new FormControl({ value: walletOwner.idProofNumber, disabled: !editMode }, Validators.required);
        group['idProofTypeCode'] = new FormControl({ value: walletOwner.idProofTypeCode, disabled: !editMode }, Validators.required);
        group['issuingCountryCode'] = new FormControl({ value: walletOwner.issuingCountryCode, disabled: true }, Validators.required);
        group['registerCountryCode'] = new FormControl({ value: walletOwner.registerCountryCode, disabled: true }, Validators.required);
        group['lineOfBusiness'] = new FormControl({ value: walletOwner.lineOfBusiness, disabled: !editMode }, Validators.required);
        group['mobileNumber'] = new FormControl({ value: walletOwner.mobileNumber, disabled: !editMode }, Validators.required);
        group['code'] = new FormControl({ value: walletOwner.code, disabled: true }, Validators.required);
    ...
    public updateBasicInfo(walletOwnerCode: string, basicInfoData: any): Observable<any> {
        ...
        return this.http.put(this.endpoints.E_WALLET_OWNER_URL + '/employer/' + walletOwnerCode,
            basicInfoData);
    }
        ...
        if (addressList.length > 0) {
            addressList.forEach(address => {
                addresses.push(new FormGroup({
                    addTypeCode: new FormControl({ value: address.addTypeCode, disabled:  !editMode }, Validators.required),
            ...
            addresses.push(this.blankAddressForm(editMode) );
        }
        return addresses;
    }

    public  blankAddressForm( editMode: boolean) {
        return new FormGroup({
            // addTypeCode: new FormControl(''),
            ...
            // location: new FormControl('')
                    addTypeCode: new FormControl({ value: '', disabled: !editMode }, Validators.required),
                    countryCode: new FormControl({ value:'', disabled: !editMode }, Validators.required),
                    regionCode: new FormControl({ value:'', disabled: !editMode }, Validators.required),
                    city: new FormControl({ value:'', disabled: !editMode }),
                    addressLine1: new FormControl({ value: '', disabled: !editMode }, Validators.required),
                    addressLine2: new FormControl({ value: '', disabled: !editMode }),
                    location: new FormControl({ value: '', disabled: !editMode }, Validators.required)
        });
    }
