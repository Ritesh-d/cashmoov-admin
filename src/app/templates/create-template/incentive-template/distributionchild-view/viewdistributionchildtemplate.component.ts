...
@Component({
    selector: 'app-incentiveviewservicetemplate',
    templateUrl: './viewdistributionchildtemplate.component.html',
    styleUrls: ['./viewdistributionchildtemplate.component.css']
})
export class ViewDistributionComponent {
    @Input() data;
    taxTypeList: any;
    taxTypeCode: any;
    selected: any = [];
    ...
    constructor(private templateService: IncentiveTemplateService, public activeModal: NgbActiveModal, private router: Router, private activatedrouter: ActivatedRoute,
