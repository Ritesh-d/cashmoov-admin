...
@Injectable()
export class ViewOutletService {
    ...
    createBasicInfoForm(walletOwner: any, editMode: boolean): FormGroup {
        ...
        // walletOwner.walletOwnerCategoryCode = WalletOwnerConstants.category.OUTLET_CODE;
        let group = {};
        ...
        group['walletExists'] = new FormControl({ value: walletOwner.walletExists, disabled: !editMode });
    ...
    public updateBasicInfo(walletOwnerCode: string, basicInfoData: any): Observable<any> {
        ...
        return this.http.put(this.endpoints.E_WALLET_OWNER_URL + '/outlet/' + walletOwnerCode,
            basicInfoData);
    }
    ...
    prepareBasicInfoUpdatedData(unchangedData: any, changedData: any): any {
        ...
        if (unchangedData.walletExists != changedData.walletExists) {
            updatedData.walletExists = changedData.walletExists;
        }
